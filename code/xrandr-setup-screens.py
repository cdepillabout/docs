...
LCD_ACTIVE_REGEX = 'LVDS-1 connected 1920x1080+0+600 (normal left inverted right x axis y axis) 344mm x 193mm\n   1920x1080      60.0*+   60.0     50.0'
EXTERNAL_MONITOR_ACTIVE_REGEX = 'DVI-I-1 connected 1080x1920+1920+0 left (normal left inverted right x axis y axis) 510mm x 287mm\n   1920x1080      60.0*+   50.0'
TV_ACTIVE_REGEX = 'HDMI-1 connected 1920x1080+0+600 (normal left inverted right x axis y axis) 886mm x 498mm\n   1920x1080      60.0*+   30.0     24.0     30.0'
...
def main():
    ...
    lcd_active = False
    if re.search(re.escape(LCD_ACTIVE_REGEX), out):
        lcd_active = True
    ...
    tv_active = False
    if re.search(re.escape(TV_ACTIVE_REGEX), out):
        tv_active = True
    ...
    if re.search(re.escape(EXTERNAL_MONITOR_ACTIVE_REGEX), out):
